...
public class IXAAnnotatorEU implements IXAAnnotator{

    private static final Logger LOG = LoggerFactory.getLogger(IXAAnnotatorEU.class);
    ...
    public IXAAnnotatorEU(String resourceFolder) {
        model              = Paths.get(resourceFolder,"morph-models-"+ IXAService.kafVersion+"/eu/eu-pos-perceptron-epec.bin").toFile().getAbsolutePath();
        lemmatizerModel    = Paths.get(resourceFolder,"morph-models-"+ IXAService.kafVersion+"/eu/eu-lemma-perceptron-epec.bin").toFile().getAbsolutePath();
        language           = "it";
