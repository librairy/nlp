...
public class IXAAnnotatorIT implements IXAAnnotator{

    private static final Logger LOG = LoggerFactory.getLogger(IXAAnnotatorIT.class);
    ...
    public IXAAnnotatorIT(String resourceFolder) {
        model              = Paths.get(resourceFolder,"morph-models-"+ IXAService.kafVersion+"/it/it-pos-perceptron-autodict01-ud.bin").toFile().getAbsolutePath();
        lemmatizerModel    = Paths.get(resourceFolder,"morph-models-"+ IXAService.kafVersion+"/it/it-lemma-perceptron-ud.bin").toFile().getAbsolutePath();
        language           = "it";
