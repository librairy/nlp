 ...
 * @version  0.9.9.9
 */
public class SuperlativeNormalizer extends Normalizer {
  ...
  /**
   * Creates a new <code>SuperlativeNormalizer</code> object ...
   * 
   * @param  declensions ...
   */
  public SuperlativeNormalizer(Replacement[] declensions) {
  ...
  /**
   * This method retrieves the normal form of a given adjective, if it exists,
